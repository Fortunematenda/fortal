<x-app-layout>
            ...
            <div class="col-md-5 col-xl-4">
                <div class="card">
                    ...
                    <div class="list-group list-group-flush" role="tablist">
                        ...
                        <a class="list-group-item list-group-item-action" data-toggle="list" href="#dataprivacy" role="tab">
                            Privacy and safety
                        </a>
    ...
    <input type="text" id="contact_number" name="contact_number" class="form-control mb-1" 
           value="{{ old('contact_number', $user->contact_number) }}" 
           pattern="^\+27\d{9}$" 
           maxlength="12" 
           oninput="validateContactNumber(this)" 
           required />
    <small class="text-danger" id="contact_number_error" style="display:none;">
        Contact number must start with +27 and be exactly 12 characters long.
    </small>
</div>

<script>
function validateContactNumber(input) {
    let regex = /^\+27\d{9}$/; // Must start with +27 followed by 9 digits
    let errorElement = document.getElementById('contact_number_error');
    ...
    <div class="text-right mt-3">
        ...
        <a href="{{ route('profile.edit') }}" class="btn btn-secondary">Cancel</a>
                                ...
                                <div class="tab-pane fade" id="dataprivacy" role="tabpanel">
                                        <div class="card">
                                            <div class="card-body">
...
<li>
<p><strong>Application</strong> refers to Fortai, the software program provided by the Company.</p>
</li>
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Fortai, Fish Hoek, Cape Town.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Fortai, accessible from <a href="http://www.fortai.com" rel="external nofollow noopener" target="_blank">http://www.fortai.com</a></p>
</li>
<li>
...
<ul>
<li>
<p>By email: support@fortai.com</p>
</li>
<li>
<p>By visiting this page on our website: <a href="http://www.fortai.com" rel="external nofollow noopener" target="_blank">http://www.fortai.com</a></p>
</li>
</ul>
                                        </div>
                                    </div>
